...
with open('_qsuite/results_deleting_edges_34_N_meas_100/results_mean_std.p','rb') as f:
    data34 = pickle.load(f)
with open('_qsuite/results_deleting_edges_N_meas_100/results_mean_std.p','rb') as f:
    data40 = pickle.load(f)
datas = [data30,data34,data40]
figs,axs = pl.subplots(4,1)

for data in datas:
    ax2 = axs[datas.index(data)]
    means = data['means']
    stds = data['stds']
