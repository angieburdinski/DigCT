...
with open('_qsuite/results_deleting_edges_30_N_meas_100/results.p','rb') as f:
    data = pickle.load(f)
...
with open('_qsuite/results_deleting_edges_30_N_meas_100/results_mean_std.p','wb') as f:
