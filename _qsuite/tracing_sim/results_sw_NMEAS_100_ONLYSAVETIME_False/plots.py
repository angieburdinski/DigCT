...
def removed():
    ...
    plt.title('R0 = 2.5 z = 0.32')
    plt.savefig('R0 = 2_5 z = 0_32 Rmax')
    plt.show()
    ...
    plt.ylabel(' $R_{max}$',**hfont)
    plt.title('R0 = 2.5 z = 0.64')
    plt.savefig('R0 = 2_5 z = 0_64 Rmax')
    plt.show()
    ...
    plt.ylabel(' $R_{max}$',**hfont)
    plt.title('R0 = 2.6 z = 0.32')
    plt.savefig('R0 = 2_6 z = 0_32 Rmax')
    plt.show()
    ...
    plt.ylabel(' $R_{max}$',**hfont)
    plt.title('R0 = 2.6 z = 0.64')
    plt.savefig('R0 = 2_6 z = 0_64 Rmax')
    plt.show()
#removed()
def known_quarantined():
    ...
    plt.title('R0 = 2.5 z = 0.32')
    plt.savefig('R0 = 2_5 z = 0_32 Xmax')
    plt.show()
    ...
    plt.ylabel(' $X_{max}$',**hfont)
    plt.title('R0 = 2.5 z = 0.64')
    plt.savefig('R0 = 2_5 z = 0_64 Xmax')
    plt.show()
    ...
    plt.ylabel(' $X_{max}$',**hfont)
    plt.title('R0 = 2.6 z = 0.32')
    plt.savefig('R0 = 2_6 z = 0_32 Xmax')
    plt.show()
    ...
    plt.ylabel(' $X_{max}$',**hfont)
    plt.title('R0 = 2.6 z = 0.64')
    plt.savefig('R0 = 2_6 z = 0_64 Xmax')
    plt.show()
#known_quarantined()
...
def unknown_quarantined():
    ...
    plt.title('R0 = 2.5 z = 0.32')
    plt.savefig('R0 = 2_5 z = 0_32 Cmax')
    plt.show()
    ...
    plt.ylabel(' $C_{max}$',**hfont)
    plt.title('R0 = 2.5 z = 0.64')
    plt.savefig('R0 = 2_5 z = 0_64 Cmax')
    plt.show()
    ...
    plt.ylabel(' $C_{max}$',**hfont)
    plt.title('R0 = 2.6 z = 0.32')
    plt.savefig('R0 = 2_6 z = 0_32 Cmax')
    plt.show()
    ...
    plt.ylabel(' $C_{max}$',**hfont)
    plt.title('R0 = 2.6 z = 0.64')
    plt.savefig('R0 = 2_6 z = 0_64 Cmax')
    plt.show()
#unknown_quarantined()
