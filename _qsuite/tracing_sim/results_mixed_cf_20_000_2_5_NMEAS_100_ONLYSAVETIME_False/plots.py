...
data = pickle.load(gzip.open('/Users/angeliqueburdinski/Desktop/Arbeit/tracing_sim/results_mixed_cf_20_000_2_5_NMEAS_100_ONLYSAVETIME_False/results.p.gz','rb'))
data = np.array(data)
colors = [
        'dimgrey',
        'lightcoral',
