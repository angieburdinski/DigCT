...
data = pickle.load(gzip.open('/Users/angeliqueburdinski/Desktop/Arbeit/tracing_sim/results_mixed_sw_20_000_2_5_perfect_test_NMEAS_10_ONLYSAVETIME_False/results.p.gz','rb'))
data = np.array(data)
colors = [
        'dimgrey',
        'lightcoral',
...
def sw_plot():
    ...
    for x in range(len(data)):
        axs[0,1].plot(cf.a,data[x,:,2,1],'o', alpha = 0.1, color = colors[2])
        axs[0,1].set_title("q = 0.1",**hfont)
    for x in range(len(data)):
        axs[0,2].plot(cf.a,data[x,:,3,1],'o', alpha = 0.1, color = colors[3])
        axs[0,2].set_title("q = 0.3",**hfont)
    for x in range(len(data)):
        axs[1,0].plot(cf.a,data[x,:,4,1],'o', alpha = 0.1, color = colors[4])
        axs[1,0].set_title("q = 0.5",**hfont)
        axs[1,0].set_xlabel("a",**hfont)
        axs[1,0].set_ylabel(r'$R (t\rightarrow \infty)+X (t\rightarrow \infty)$',**hfont)
    for x in range(len(data)):
        axs[1,1].plot(cf.a,data[x,:,5,1],'o', alpha = 0.1, color = colors[5])
        axs[1,1].set_title("q = 0.7",**hfont)
        axs[1,1].set_xlabel("a",**hfont)
    for x in range(len(data)):
        axs[1,2].plot(cf.a,data[x,:,6,1],'o', alpha = 0.1, color = colors[6])
        axs[1,2].set_title("q = 0.9",**hfont)
    ...
    for x in range(len(data)):
        axs[0,1].plot(cf.a,data[x,:,2,0],'o', alpha = 0.1, color = colors[2])
        axs[0,1].set_title("q = 0.1",**hfont)
    for x in range(len(data)):
        axs[0,2].plot(cf.a,data[x,:,3,0],'o', alpha = 0.1, color = colors[3])
        axs[0,2].set_title("q = 0.3",**hfont)
    for x in range(len(data)):
        axs[1,0].plot(cf.a,data[x,:,4,0],'o', alpha = 0.1, color = colors[4])
        axs[1,0].set_title("q = 0.5",**hfont)
        axs[1,0].set_xlabel("a",**hfont)
        axs[1,0].set_ylabel(r'$I_{S_{max}}$',**hfont)
    for x in range(len(data)):
        axs[1,1].plot(cf.a,data[x,:,5,0],'o', alpha = 0.1, color = colors[5])
        axs[1,1].set_title("q = 0.7",**hfont)
        axs[1,1].set_xlabel("a",**hfont)
    for x in range(len(data)):
        axs[1,2].plot(cf.a,data[x,:,6,0],'o', alpha = 0.1, color = colors[6])
        axs[1,2].set_title("q = 0.9",**hfont)
        axs[1,2].set_xlabel("a",**hfont)
    plt.tight_layout()
