...
def Fig1():
    ...
    print(mean_omega[0][0],mean_omega[5][0], 1-(mean_omega[5][0]/mean_omega[0][0]))
    print(mean_DF[1][0],mean_DF[5][0])
    print(mean_omega[2][7],mean_omega[2][12],(mean_omega[2][12]/mean_omega[2][7]))
    print(mean_omega[2][7],mean_omega[3][7],(mean_omega[3][7]/mean_omega[2][7]))
    for x in range(6):
